...
## 目录
- [Jetson Nano B01 系统安装指南](#jetson-nano-b01-系统安装指南)
  - [目录](#目录)
  - [系统版本选择](#系统版本选择)
    - [官方版与社区版对比](#官方版与社区版对比)
    - [系统版本推荐](#系统版本推荐)
  - [系统烧录步骤](#系统烧录步骤)
    ...
    - [下载系统镜像](#下载系统镜像)
    - [烧录系统镜像](#烧录系统镜像)
      - [使用balenaEtcher（推荐）](#使用balenaetcher推荐)
      - [使用SD Card Formatter和Win32DiskImager（Windows替代方案）](#使用sd-card-formatter和win32diskimagerwindows替代方案)
    - [验证烧录结果](#验证烧录结果)
  - [系统初始化设置](#系统初始化设置)
    - [使用显示器和键盘进行设置（推荐）](#使用显示器和键盘进行设置推荐)
    - [使用串口进行无显示器设置（Headless）](#使用串口进行无显示器设置headless)
      - [准备工作](#准备工作-1)
      - [连接方法](#连接方法)
  - [系统设置验证](#系统设置验证)
  - [JetPack组件验证](#jetpack组件验证)
  - [常见问题](#常见问题)
  - [结语](#结语)
